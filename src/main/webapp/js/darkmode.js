...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggleIcon = (currentTheme) => {
        (currentTheme === 'light') ?
        document.documentElement.classList.add("theme--night") : document.documentElement.classList.remove("theme--night")
    };
    ...
    let theme = new DarkMode(options);
	currentTheme = theme.getMode();
